...
export default function V2FooterCorrect() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ["AVENTOS", "/v2/products/aventos"],
                ["CLIP TOP", "/v2/products#hinge"],
                ["LEGRABOX", "/v2/products#box"],
                ["MOVENTO", "/v2/products#runner"],
                ["TIP-ON", "/v2/products#motion"],
                ["REVEGO", "/v2/products#pocket"],
              ].map(([l, h]) => (
                <li key={l}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ["ABOUT", "/v2/company#about"],
                ["FACTS & FIGURES", "/v2/company#facts"],
                ["SUSTAINABILITY", "/v2/company#sustainability"],
