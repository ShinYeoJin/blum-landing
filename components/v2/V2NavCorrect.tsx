...
const MENU = [
  {
    ...
    href: "/v2/products",
    children: [
      { label: "LIFT SYSTEMS", href: "/v2/products#lift" },
      { label: "HINGE SYSTEMS", href: "/v2/products#hinge" },
      { label: "BOX SYSTEMS", href: "/v2/products#box" },
      { label: "RUNNER SYSTEMS", href: "/v2/products#runner" },
      { label: "MOTION TECH", href: "/v2/products#motion" },
      { label: "POCKET SYSTEMS", href: "/v2/products#pocket" },
    ],
  },
  { label: "SERVICES", href: "/v2/services", children: [] },
  { label: "COMPANY", href: "/v2/company", children: [] },
];
...
function ContactBtn() {
  ...
  return (
    <a
      ...
      style={{ backgroundColor: RED, color: "#fff", textDecoration: "none", display: "inline-block" }}
      onMouseEnter={() => setOn(true)}
      onMouseLeave={() => setOn(false)}
    >
      {on ? "LET'S CONNECT" : "CONTACT"}
    </a>
  );
}

export default function V2NavCorrect() {
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          {/* Logo */}
          <Link href="/v2" style={{ color: "#f0f0f0", textDecoration: "none", fontSize: "18px", fontWeight: 900, letterSpacing: "-0.01em" }}>
            BLUM
          </Link>
