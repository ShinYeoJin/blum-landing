    ...
    <div style={{ backgroundColor: "#050505", color: "#f0f0f0", fontFamily: "'Helvetica Neue', Arial, sans-serif", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <div className="max-w-7xl mx-auto px-8 h-full flex items-center justify-between">
          <Link href="/v3" style={{ color: "#D4AF37", textDecoration: "none", fontSize: "22px", fontWeight: 300, letterSpacing: "0.3em", fontFamily: "'Cormorant Garamond', Georgia, serif" }}>blum</Link>
