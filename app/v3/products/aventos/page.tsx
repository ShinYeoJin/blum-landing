...
const VARIANTS = [
  {
    ...
    desc: "도어가 중앙에서 두 부분으로 접히며 열립니다. 대형 상부장을 위한 최강의 리프트.",
  ...
  },
  {
    ...
    name: "AVENTOS HL",
    sub: "PARALLEL LIFT",
    desc: "캐비닛과 평행하게 들어 올리는 원파트 도어. 공간 효율의 극대화.",
  ...
  },
  {
    ...
    name: "AVENTOS HS",
    sub: "SWING UP",
    desc: "원파트 도어가 캐비닛 위로 스윙. 대형 도어도 깃털처럼 가볍게.",
  ...
  },
  {
    ...
    name: "AVENTOS HK",
    sub: "STAY LIFT",
    desc: "120개국이 선택한 리프트 시스템. 어떤 크기의 도어에도 완벽한 솔루션.",
  ...
  },
  {
    ...
    name: "AVENTOS HK-S",
    sub: "STAY LIFT SMALL",
    desc: "소형·경량 도어를 위한 컴팩트 리프트. 작지만 강하다.",
  ...
  },
  {
    ...
    name: "AVENTOS HKi",
    sub: "INTEGRATED",
    desc: "가구와 완전히 하나가 된 스테이 리프트. 피팅이 보이지 않는 완벽한 통합.",
      ...
      <section className="pt-36 pb-12 px-6 max-w-7xl mx-auto">
        <BoldReveal>
          <div className="flex items-center gap-2 text-[9px] tracking-[0.3em] uppercase font-black mb-8"
            ...
            <Link href="/v3/products" style={{ textDecoration: "none", color: "inherit" }}
