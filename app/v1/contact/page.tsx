          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <Link href="/v1/contact"
                className="inline-block text-xs tracking-[0.2em] uppercase px-5 py-2.5 border border-zinc-900 hover:bg-zinc-900 hover:text-white transition-colors"
          ...
          <div className="md:col-span-2">
            ...
            {submitted ? (
              ...
              <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full py-4 text-xs tracking-[0.2em] uppercase transition-colors hover:bg-zinc-700"
